      ...
      const processedChildren = useMemo(() => {
        ...
        React.Children.forEach(children, child => {
          ...
          const element = motionTag
            ? createElement(CustomMotion, { ...childProps }, childProps.children)
            : child;
      ...
      useEffect(() => {
        processedChildren.forEach((child, index) => {
          ...
          const itemInfo: ItemInfo = {
            dataMagicpathPath: (child.node as any)?.props?.['data-magicpath-path'],
            dataMagicpathId: (child.node as any)?.props?.['data-magicpath-id'],
            dataMagicpathUuid: (child.node as any)?.props?.['data-magicpath-uuid'],
            dndKitId: (child.node as any)?.props?.['dndKitId'],
            containerId,
